...
; CI-NEXT:    ds_read_u8 v3, v1 offset:5
; CI-NEXT:    ds_read_u8 v4, v1 offset:8
; CI-NEXT:    ds_read_u8 v5, v1 offset:7
; CI-NEXT:    ds_read_u8 v6, v1 offset:12
; CI-NEXT:    s_waitcnt lgkmcnt(4)
; CI-NEXT:    v_lshlrev_b32_e32 v2, 8, v2
; CI-NEXT:    s_waitcnt lgkmcnt(3)
; CI-NEXT:    v_or_b32_e32 v2, v2, v3
...
; CI-NEXT:    ds_read_u8 v1, v1 offset:11
; CI-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; CI-NEXT:    v_or_b32_e32 v2, v3, v2
; CI-NEXT:    s_waitcnt lgkmcnt(0)
...
; CI-NEXT:    ds_read2_b32 v[4:5], v0 offset1:1
...
; CI-NEXT:    ds_read_u8 v2, v0 offset:69
; CI-NEXT:    ds_read_u8 v3, v0 offset:72
; CI-NEXT:    ds_read_u8 v4, v0 offset:71
...
; CI-NEXT:    s_waitcnt lgkmcnt(2)
; CI-NEXT:    v_lshlrev_b32_e32 v2, 8, v3
; CI-NEXT:    ds_read_u8 v3, v0 offset:66
; CI-NEXT:    s_waitcnt lgkmcnt(2)
; CI-NEXT:    v_or_b32_e32 v2, v2, v4
; CI-NEXT:    ds_read_u8 v4, v0 offset:65
; CI-NEXT:    ds_read_u8 v0, v0 offset:67
; CI-NEXT:    s_load_dwordx2 s[0:1], s[4:5], 0x0
; CI-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
