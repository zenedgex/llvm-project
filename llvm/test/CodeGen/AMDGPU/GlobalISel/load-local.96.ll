...
; GFX9-NEXT:    ds_read_u8 v6, v0 offset:7
...
; GFX9-NEXT:    v_or3_b32 v3, v3, v4, v1
; GFX9-NEXT:    s_waitcnt lgkmcnt(1)
; GFX9-NEXT:    v_lshlrev_b32_e32 v4, 24, v6
; GFX9-NEXT:    s_waitcnt lgkmcnt(0)
; GFX9-NEXT:    v_lshl_or_b32 v1, v2, 8, v5
; GFX9-NEXT:    ds_read_u8 v2, v0 offset:6
; GFX9-NEXT:    ds_read_u8 v5, v0 offset:8
; GFX9-NEXT:    ds_read_u8 v6, v0 offset:9
; GFX9-NEXT:    ds_read_u8 v7, v0 offset:11
; GFX9-NEXT:    ds_read_u8 v0, v0 offset:10
; GFX9-NEXT:    s_waitcnt lgkmcnt(4)
; GFX9-NEXT:    v_lshlrev_b32_e32 v2, 16, v2
; GFX9-NEXT:    v_or3_b32 v1, v4, v2, v1
...
; GFX9-NEXT:    v_or3_b32 v2, v4, v0, v2
...
; GFX7-NEXT:    s_waitcnt lgkmcnt(2)
; GFX7-NEXT:    v_lshlrev_b32_e32 v1, 8, v4
...
; GFX7-NEXT:    ds_read_u8 v0, v0 offset:10
...
; GFX7-NEXT:    ds_read_u16 v2, v0
; GFX7-NEXT:    ds_read_u16 v4, v0 offset:6
; GFX7-NEXT:    ds_read_u16 v5, v0 offset:10
; GFX7-NEXT:    ds_read_u16 v3, v0 offset:4
; GFX7-NEXT:    ds_read_u16 v6, v0 offset:8
; GFX7-NEXT:    s_waitcnt lgkmcnt(5)
; GFX7-NEXT:    v_lshlrev_b32_e32 v1, 16, v1
; GFX7-NEXT:    s_waitcnt lgkmcnt(4)
; GFX7-NEXT:    v_or_b32_e32 v0, v1, v2
; GFX7-NEXT:    s_waitcnt lgkmcnt(3)
