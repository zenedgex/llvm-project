...
; GFX7-NEXT:    ds_read_u8 v6, v0 offset:7
...
; GFX7-NEXT:    v_lshlrev_b32_e32 v2, 8, v3
...
; GFX7-NEXT:    ds_read_u8 v5, v0 offset:13
; GFX7-NEXT:    ds_read_u8 v7, v0 offset:15
; GFX7-NEXT:    ds_read_u8 v6, v0 offset:12
; GFX7-NEXT:    ds_read_u8 v0, v0 offset:14
; GFX7-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GFX7-NEXT:    v_or_b32_e32 v2, v3, v2
; GFX7-NEXT:    s_waitcnt lgkmcnt(3)
; GFX7-NEXT:    v_lshlrev_b32_e32 v3, 8, v5
; GFX7-NEXT:    s_waitcnt lgkmcnt(2)
; GFX7-NEXT:    v_lshlrev_b32_e32 v5, 8, v7
; GFX7-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, 9, v0
; GFX6-NEXT:    v_add_i32_e32 v5, vcc, 11, v0
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_or_b32_e32 v2, v2, v4
; GFX6-NEXT:    ds_read_u8 v3, v3
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, 8, v0
; GFX6-NEXT:    ds_read_u8 v5, v5
; GFX6-NEXT:    v_add_i32_e32 v6, vcc, 10, v0
; GFX6-NEXT:    ds_read_u8 v4, v4
...
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, 13, v0
; GFX6-NEXT:    v_add_i32_e32 v6, vcc, 15, v0
; GFX6-NEXT:    ds_read_u8 v4, v4
; GFX6-NEXT:    ds_read_u8 v6, v6
; GFX6-NEXT:    v_add_i32_e32 v7, vcc, 14, v0
; GFX6-NEXT:    v_add_i32_e32 v5, vcc, 12, v0
; GFX6-NEXT:    ds_read_u8 v7, v7
; GFX6-NEXT:    ds_read_u8 v5, v5
; GFX6-NEXT:    v_lshlrev_b32_e32 v3, 16, v3
; GFX6-NEXT:    v_or_b32_e32 v2, v3, v2
; GFX6-NEXT:    s_waitcnt lgkmcnt(3)
; GFX6-NEXT:    v_lshlrev_b32_e32 v3, 8, v4
; GFX6-NEXT:    s_waitcnt lgkmcnt(2)
; GFX6-NEXT:    v_lshlrev_b32_e32 v4, 8, v6
; GFX6-NEXT:    s_waitcnt lgkmcnt(1)
; GFX6-NEXT:    v_or_b32_e32 v4, v4, v7
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_or_b32_e32 v3, v3, v5
; GFX6-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GFX6-NEXT:    v_or_b32_e32 v3, v4, v3
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, 3, v0
; GFX6-NEXT:    ds_read_u8 v4, v4
...
; GFX6-NEXT:    s_waitcnt lgkmcnt(1)
; GFX6-NEXT:    v_lshlrev_b32_e32 v5, 8, v6
; GFX6-NEXT:    v_lshlrev_b32_e32 v4, 16, v4
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
...
; GFX7-NEXT:    ds_read_u16 v3, v0
; GFX7-NEXT:    ds_read_u16 v2, v0 offset:6
; GFX7-NEXT:    ds_read_u16 v6, v0 offset:14
...
; GFX7-NEXT:    ds_read_u16 v3, v0 offset:10
; GFX7-NEXT:    ds_read_u16 v0, v0 offset:12
...
; GFX6-NEXT:    v_add_i32_e32 v4, vcc, 14, v0
; GFX6-NEXT:    s_waitcnt lgkmcnt(1)
; GFX6-NEXT:    v_or_b32_e32 v1, v1, v2
; GFX6-NEXT:    s_waitcnt lgkmcnt(0)
; GFX6-NEXT:    v_lshlrev_b32_e32 v2, 16, v3
; GFX6-NEXT:    v_add_i32_e32 v3, vcc, 8, v0
...
; GFX6-NEXT:    v_add_i32_e32 v0, vcc, 12, v0
