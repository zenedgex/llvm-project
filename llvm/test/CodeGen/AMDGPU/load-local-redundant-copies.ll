...
; CHECK-NEXT:    v_add_i32_e32 v4, vcc, 16, v1
; CHECK-NEXT:    v_add_i32_e32 v5, vcc, 28, v1
; CHECK-NEXT:    v_add_i32_e32 v10, vcc, 24, v1
; CHECK-NEXT:    v_add_i32_e32 v6, vcc, 12, v1
; CHECK-NEXT:    v_add_i32_e32 v7, vcc, 8, v1
; CHECK-NEXT:    v_add_i32_e32 v11, vcc, 4, v1
; CHECK-NEXT:    s_mov_b32 m0, -1
; CHECK-NEXT:    ds_read_b32 v3, v2
; CHECK-NEXT:    ds_read_b32 v2, v4
; CHECK-NEXT:    ds_read_b32 v5, v5
; CHECK-NEXT:    ds_read_b32 v9, v6
; CHECK-NEXT:    ds_read_b32 v8, v7
; CHECK-NEXT:    ds_read_b32 v7, v11
...
; CHECK-NEXT:    v_add_i32_e32 v8, vcc, 16, v1
