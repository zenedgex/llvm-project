...
; CHECK-i64-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-i64-NEXT:    uunpklo z0.d, z0.s
; CHECK-i64-NEXT:    fcvt z0.d, p0/m, z0.s
...
; CHECK-i32-NEXT:    fcvt z0.s, p0/m, z0.h
...
; CHECK-i64-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-i64-NEXT:    fcvtl v1.4s, v1.4h
; CHECK-i64-NEXT:    uunpklo z0.d, z0.s
; CHECK-i64-NEXT:    uunpklo z1.d, z1.s
; CHECK-i64-NEXT:    fcvt z0.d, p0/m, z0.s
; CHECK-i64-NEXT:    movprfx z2, z1
; CHECK-i64-NEXT:    fcvt z2.d, p0/m, z1.s
; CHECK-i64-NEXT:    movprfx z1, z0
; CHECK-i64-NEXT:    ext z1.b, z1.b, z0.b, #16
; CHECK-i64-NEXT:    fcvtzs v0.2d, v0.2d
; CHECK-i64-NEXT:    fcvtzs v1.2d, v1.2d
...
; CHECK-i32-NEXT:    fcvt z0.s, p0/m, z0.h
; CHECK-i32-NEXT:    fcvt z1.s, p0/m, z1.h
; CHECK-i32-NEXT:    movprfx z3, z0
; CHECK-i32-NEXT:    ext z3.b, z3.b, z0.b, #16
; CHECK-i32-NEXT:    movprfx z4, z1
; CHECK-i32-NEXT:    ext z4.b, z4.b, z1.b, #16
; CHECK-i32-NEXT:    fcvtzs v0.4s, v0.4s
; CHECK-i32-NEXT:    fcvtzs v2.4s, v1.4s
; CHECK-i32-NEXT:    fcvtzs v1.4s, v3.4s
; CHECK-i32-NEXT:    fcvtzs v3.4s, v4.4s
; CHECK-i32-NEXT:    ret
;
...
; CHECK-i64-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-i64-NEXT:    fcvtl v1.4s, v1.4h
; CHECK-i64-NEXT:    fcvtl v2.4s, v2.4h
; CHECK-i64-NEXT:    fcvtl v3.4s, v3.4h
; CHECK-i64-NEXT:    uunpklo z0.d, z0.s
; CHECK-i64-NEXT:    uunpklo z1.d, z1.s
; CHECK-i64-NEXT:    uunpklo z2.d, z2.s
; CHECK-i64-NEXT:    uunpklo z3.d, z3.s
; CHECK-i64-NEXT:    fcvt z0.d, p0/m, z0.s
; CHECK-i64-NEXT:    fcvt z1.d, p0/m, z1.s
; CHECK-i64-NEXT:    fcvt z2.d, p0/m, z2.s
; CHECK-i64-NEXT:    movprfx z6, z3
; CHECK-i64-NEXT:    fcvt z6.d, p0/m, z3.s
; CHECK-i64-NEXT:    movprfx z3, z0
; CHECK-i64-NEXT:    ext z3.b, z3.b, z0.b, #16
; CHECK-i64-NEXT:    movprfx z7, z1
; CHECK-i64-NEXT:    ext z7.b, z7.b, z1.b, #16
; CHECK-i64-NEXT:    fcvtzs v0.2d, v0.2d
; CHECK-i64-NEXT:    fcvtzs v4.2d, v1.2d
; CHECK-i64-NEXT:    fcvtzs v1.2d, v3.2d
; CHECK-i64-NEXT:    movprfx z5, z2
; CHECK-i64-NEXT:    ext z5.b, z5.b, z2.b, #16
; CHECK-i64-NEXT:    movprfx z16, z6
; CHECK-i64-NEXT:    ext z16.b, z16.b, z6.b, #16
; CHECK-i64-NEXT:    fcvtzs v2.2d, v2.2d
; CHECK-i64-NEXT:    fcvtzs v6.2d, v6.2d
; CHECK-i64-NEXT:    fcvtzs v3.2d, v5.2d
; CHECK-i64-NEXT:    fcvtzs v5.2d, v7.2d
; CHECK-i64-NEXT:    fcvtzs v7.2d, v16.2d
; CHECK-i64-NEXT:    ret
...
; CHECK-i32-NEXT:    uunpklo z0.s, z0.h
; CHECK-i32-NEXT:    uunpklo z1.s, z1.h
; CHECK-i32-NEXT:    uunpklo z2.s, z2.h
; CHECK-i32-NEXT:    uunpklo z3.s, z3.h
; CHECK-i32-NEXT:    fcvt z0.s, p0/m, z0.h
; CHECK-i32-NEXT:    fcvt z1.s, p0/m, z1.h
; CHECK-i32-NEXT:    movprfx z4, z2
; CHECK-i32-NEXT:    fcvt z4.s, p0/m, z2.h
; CHECK-i32-NEXT:    movprfx z5, z3
; CHECK-i32-NEXT:    fcvt z5.s, p0/m, z3.h
; CHECK-i32-NEXT:    movprfx z3, z0
; CHECK-i32-NEXT:    ext z3.b, z3.b, z0.b, #16
; CHECK-i32-NEXT:    movprfx z6, z1
; CHECK-i32-NEXT:    ext z6.b, z6.b, z1.b, #16
; CHECK-i32-NEXT:    movprfx z7, z4
; CHECK-i32-NEXT:    ext z7.b, z7.b, z4.b, #16
; CHECK-i32-NEXT:    movprfx z16, z5
; CHECK-i32-NEXT:    ext z16.b, z16.b, z5.b, #16
; CHECK-i32-NEXT:    fcvtzs v0.4s, v0.4s
; CHECK-i32-NEXT:    fcvtzs v2.4s, v1.4s
; CHECK-i32-NEXT:    fcvtzs v4.4s, v4.4s
; CHECK-i32-NEXT:    fcvtzs v1.4s, v3.4s
; CHECK-i32-NEXT:    fcvtzs v3.4s, v6.4s
; CHECK-i32-NEXT:    fcvtzs v6.4s, v5.4s
; CHECK-i32-NEXT:    fcvtzs v5.4s, v7.4s
; CHECK-i32-NEXT:    fcvtzs v7.4s, v16.4s
; CHECK-i32-NEXT:    ret
;
...
; CHECK-i64-NEXT:    ext v7.16b, v2.16b, v2.16b, #8
...
; CHECK-i64-NEXT:    fcvtl v1.4s, v1.4h
; CHECK-i64-NEXT:    fcvtl v0.4s, v0.4h
; CHECK-i64-NEXT:    fcvtl v4.4s, v4.4h
; CHECK-i64-NEXT:    uunpklo z3.d, z3.s
; CHECK-i64-NEXT:    fcvtl v7.4s, v7.4h
; CHECK-i64-NEXT:    fcvtl v6.4s, v6.4h
; CHECK-i64-NEXT:    uunpklo z2.d, z2.s
; CHECK-i64-NEXT:    fcvtl v5.4s, v5.4h
; CHECK-i64-NEXT:    uunpklo z1.d, z1.s
; CHECK-i64-NEXT:    uunpklo z0.d, z0.s
; CHECK-i64-NEXT:    uunpklo z4.d, z4.s
; CHECK-i64-NEXT:    fcvt z3.d, p0/m, z3.s
...
; CHECK-i64-NEXT:    fcvt z1.d, p0/m, z1.s
; CHECK-i64-NEXT:    fcvt z0.d, p0/m, z0.s
; CHECK-i64-NEXT:    movprfx z16, z3
; CHECK-i64-NEXT:    ext z16.b, z16.b, z3.b, #16
; CHECK-i64-NEXT:    fcvt z4.d, p0/m, z4.s
; CHECK-i64-NEXT:    fcvtzs v3.2d, v3.2d
; CHECK-i64-NEXT:    movprfx z19, z2
; CHECK-i64-NEXT:    ext z19.b, z19.b, z2.b, #16
; CHECK-i64-NEXT:    fcvt z7.d, p0/m, z7.s
; CHECK-i64-NEXT:    fcvt z6.d, p0/m, z6.s
; CHECK-i64-NEXT:    movprfx z18, z1
; CHECK-i64-NEXT:    ext z18.b, z18.b, z1.b, #16
; CHECK-i64-NEXT:    fcvt z5.d, p0/m, z5.s
; CHECK-i64-NEXT:    fcvtzs v2.2d, v2.2d
; CHECK-i64-NEXT:    fcvtzs v16.2d, v16.2d
; CHECK-i64-NEXT:    fcvtzs v1.2d, v1.2d
; CHECK-i64-NEXT:    movprfx z17, z4
; CHECK-i64-NEXT:    ext z17.b, z17.b, z4.b, #16
; CHECK-i64-NEXT:    fcvtzs v4.2d, v4.2d
; CHECK-i64-NEXT:    fcvtzs v19.2d, v19.2d
; CHECK-i64-NEXT:    movprfx z20, z7
; CHECK-i64-NEXT:    ext z20.b, z20.b, z7.b, #16
; CHECK-i64-NEXT:    movprfx z21, z6
; CHECK-i64-NEXT:    ext z21.b, z21.b, z6.b, #16
; CHECK-i64-NEXT:    fcvtzs v18.2d, v18.2d
; CHECK-i64-NEXT:    fcvtzs v7.2d, v7.2d
; CHECK-i64-NEXT:    fcvtzs v6.2d, v6.2d
; CHECK-i64-NEXT:    fcvtzs v17.2d, v17.2d
; CHECK-i64-NEXT:    splice z3.d, p1, z3.d, z16.d
; CHECK-i64-NEXT:    movprfx z16, z5
; CHECK-i64-NEXT:    ext z16.b, z16.b, z5.b, #16
; CHECK-i64-NEXT:    fcvtzs v20.2d, v20.2d
; CHECK-i64-NEXT:    splice z2.d, p1, z2.d, z19.d
; CHECK-i64-NEXT:    fcvtzs v19.2d, v21.2d
; CHECK-i64-NEXT:    splice z1.d, p1, z1.d, z18.d
; CHECK-i64-NEXT:    fcvtzs v5.2d, v5.2d
; CHECK-i64-NEXT:    fcvtzs v16.2d, v16.2d
; CHECK-i64-NEXT:    splice z4.d, p1, z4.d, z17.d
; CHECK-i64-NEXT:    movprfx z17, z0
; CHECK-i64-NEXT:    ext z17.b, z17.b, z0.b, #16
; CHECK-i64-NEXT:    st1d { z3.d }, p0, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    fcvtzs v0.2d, v0.2d
; CHECK-i64-NEXT:    splice z7.d, p1, z7.d, z20.d
; CHECK-i64-NEXT:    mov x9, #16 // =0x10
; CHECK-i64-NEXT:    st1d { z2.d }, p0, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    mov x9, #8 // =0x8
; CHECK-i64-NEXT:    splice z6.d, p1, z6.d, z19.d
; CHECK-i64-NEXT:    fcvtzs v17.2d, v17.2d
; CHECK-i64-NEXT:    st1d { z1.d }, p0, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    mov x9, #28 // =0x1c
; CHECK-i64-NEXT:    splice z5.d, p1, z5.d, z16.d
...
; CHECK-i64-NEXT:    splice z0.d, p1, z0.d, z17.d
...
; CHECK-i64-NEXT:    ext z4.b, z4.b, z1.b, #16
; CHECK-i64-NEXT:    fcvtzs v0.2d, v0.2d
; CHECK-i64-NEXT:    fcvtzs v2.2d, v1.2d
; CHECK-i64-NEXT:    fcvtzs v1.2d, v3.2d
; CHECK-i64-NEXT:    fcvtzs v3.2d, v4.2d
; CHECK-i64-NEXT:    ret
...
; CHECK-i64-NEXT:    fcvt z0.d, p0/m, z0.s
; CHECK-i64-NEXT:    fcvt z1.d, p0/m, z1.s
; CHECK-i64-NEXT:    movprfx z4, z2
; CHECK-i64-NEXT:    fcvt z4.d, p0/m, z2.s
; CHECK-i64-NEXT:    movprfx z5, z3
; CHECK-i64-NEXT:    fcvt z5.d, p0/m, z3.s
; CHECK-i64-NEXT:    movprfx z3, z0
; CHECK-i64-NEXT:    ext z3.b, z3.b, z0.b, #16
; CHECK-i64-NEXT:    movprfx z6, z1
; CHECK-i64-NEXT:    ext z6.b, z6.b, z1.b, #16
; CHECK-i64-NEXT:    movprfx z7, z4
; CHECK-i64-NEXT:    ext z7.b, z7.b, z4.b, #16
; CHECK-i64-NEXT:    movprfx z16, z5
; CHECK-i64-NEXT:    ext z16.b, z16.b, z5.b, #16
; CHECK-i64-NEXT:    fcvtzs v0.2d, v0.2d
; CHECK-i64-NEXT:    fcvtzs v2.2d, v1.2d
; CHECK-i64-NEXT:    fcvtzs v4.2d, v4.2d
; CHECK-i64-NEXT:    fcvtzs v1.2d, v3.2d
; CHECK-i64-NEXT:    fcvtzs v3.2d, v6.2d
; CHECK-i64-NEXT:    fcvtzs v6.2d, v5.2d
; CHECK-i64-NEXT:    fcvtzs v5.2d, v7.2d
; CHECK-i64-NEXT:    fcvtzs v7.2d, v16.2d
; CHECK-i64-NEXT:    ret
...
; CHECK-i32-NEXT:    movprfx z1, z2
; CHECK-i32-NEXT:    frintx z1.s, p0/m, z2.s
; CHECK-i32-NEXT:    movprfx z5, z6
; CHECK-i32-NEXT:    frintx z5.s, p0/m, z6.s
; CHECK-i32-NEXT:    movprfx z3, z4
; CHECK-i32-NEXT:    frintx z3.s, p0/m, z4.s
; CHECK-i32-NEXT:    movprfx z6, z0
; CHECK-i32-NEXT:    ext z6.b, z6.b, z0.b, #16
; CHECK-i32-NEXT:    movprfx z7, z1
; CHECK-i32-NEXT:    ext z7.b, z7.b, z1.b, #16
; CHECK-i32-NEXT:    movprfx z17, z5
; CHECK-i32-NEXT:    ext z17.b, z17.b, z5.b, #16
; CHECK-i32-NEXT:    movprfx z16, z3
; CHECK-i32-NEXT:    ext z16.b, z16.b, z3.b, #16
; CHECK-i32-NEXT:    fcvtzs v0.4s, v0.4s
; CHECK-i32-NEXT:    fcvtzs v2.4s, v1.4s
; CHECK-i32-NEXT:    fcvtzs v4.4s, v3.4s
; CHECK-i32-NEXT:    fcvtzs v1.4s, v6.4s
; CHECK-i32-NEXT:    fcvtzs v3.4s, v7.4s
; CHECK-i32-NEXT:    fcvtzs v6.4s, v5.4s
; CHECK-i32-NEXT:    fcvtzs v5.4s, v16.4s
; CHECK-i32-NEXT:    fcvtzs v7.4s, v17.4s
; CHECK-i32-NEXT:    ret
;
...
; CHECK-i64-NEXT:    fcvt z1.d, p0/m, z1.s
; CHECK-i64-NEXT:    fcvt z0.d, p0/m, z0.s
; CHECK-i64-NEXT:    movprfx z16, z4
; CHECK-i64-NEXT:    ext z16.b, z16.b, z4.b, #16
; CHECK-i64-NEXT:    movprfx z17, z7
; CHECK-i64-NEXT:    ext z17.b, z17.b, z7.b, #16
; CHECK-i64-NEXT:    fcvtzs v4.2d, v4.2d
; CHECK-i64-NEXT:    movprfx z19, z6
; CHECK-i64-NEXT:    ext z19.b, z19.b, z6.b, #16
; CHECK-i64-NEXT:    movprfx z18, z5
; CHECK-i64-NEXT:    ext z18.b, z18.b, z5.b, #16
; CHECK-i64-NEXT:    fcvtzs v7.2d, v7.2d
; CHECK-i64-NEXT:    movprfx z20, z3
; CHECK-i64-NEXT:    ext z20.b, z20.b, z3.b, #16
; CHECK-i64-NEXT:    fcvtzs v6.2d, v6.2d
; CHECK-i64-NEXT:    movprfx z21, z2
; CHECK-i64-NEXT:    ext z21.b, z21.b, z2.b, #16
; CHECK-i64-NEXT:    fcvtzs v16.2d, v16.2d
; CHECK-i64-NEXT:    fcvtzs v17.2d, v17.2d
; CHECK-i64-NEXT:    fcvtzs v5.2d, v5.2d
; CHECK-i64-NEXT:    fcvtzs v19.2d, v19.2d
...
; CHECK-i64-NEXT:    fcvtzs v20.2d, v20.2d
; CHECK-i64-NEXT:    fcvtzs v2.2d, v2.2d
; CHECK-i64-NEXT:    splice z4.d, p1, z4.d, z16.d
; CHECK-i64-NEXT:    movprfx z16, z1
; CHECK-i64-NEXT:    ext z16.b, z16.b, z1.b, #16
; CHECK-i64-NEXT:    splice z7.d, p1, z7.d, z17.d
; CHECK-i64-NEXT:    movprfx z17, z0
; CHECK-i64-NEXT:    ext z17.b, z17.b, z0.b, #16
; CHECK-i64-NEXT:    splice z6.d, p1, z6.d, z19.d
; CHECK-i64-NEXT:    fcvtzs v19.2d, v21.2d
; CHECK-i64-NEXT:    splice z5.d, p1, z5.d, z18.d
; CHECK-i64-NEXT:    fcvtzs v1.2d, v1.2d
; CHECK-i64-NEXT:    fcvtzs v0.2d, v0.2d
; CHECK-i64-NEXT:    fcvtzs v16.2d, v16.2d
; CHECK-i64-NEXT:    splice z3.d, p1, z3.d, z20.d
; CHECK-i64-NEXT:    fcvtzs v17.2d, v17.2d
; CHECK-i64-NEXT:    st1d { z7.d }, p0, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    mov x9, #24 // =0x18
; CHECK-i64-NEXT:    st1d { z6.d }, p0, [x8, x9, lsl #3]
...
; CHECK-i64-NEXT:    st1d { z5.d }, p0, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    mov x9, #16 // =0x10
; CHECK-i64-NEXT:    splice z1.d, p1, z1.d, z16.d
; CHECK-i64-NEXT:    st1d { z4.d }, p0, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    mov x9, #12 // =0xc
; CHECK-i64-NEXT:    splice z0.d, p1, z0.d, z17.d
; CHECK-i64-NEXT:    st1d { z3.d }, p0, [x8, x9, lsl #3]
...
; CHECK-i64-NEXT:    movprfx z1, z2
; CHECK-i64-NEXT:    frintx z1.d, p0/m, z2.d
; CHECK-i64-NEXT:    movprfx z5, z6
; CHECK-i64-NEXT:    frintx z5.d, p0/m, z6.d
; CHECK-i64-NEXT:    movprfx z3, z4
; CHECK-i64-NEXT:    frintx z3.d, p0/m, z4.d
; CHECK-i64-NEXT:    movprfx z6, z0
; CHECK-i64-NEXT:    ext z6.b, z6.b, z0.b, #16
; CHECK-i64-NEXT:    movprfx z7, z1
; CHECK-i64-NEXT:    ext z7.b, z7.b, z1.b, #16
; CHECK-i64-NEXT:    movprfx z17, z5
; CHECK-i64-NEXT:    ext z17.b, z17.b, z5.b, #16
; CHECK-i64-NEXT:    movprfx z16, z3
; CHECK-i64-NEXT:    ext z16.b, z16.b, z3.b, #16
; CHECK-i64-NEXT:    fcvtzs v0.2d, v0.2d
; CHECK-i64-NEXT:    fcvtzs v2.2d, v1.2d
; CHECK-i64-NEXT:    fcvtzs v4.2d, v3.2d
; CHECK-i64-NEXT:    fcvtzs v1.2d, v6.2d
; CHECK-i64-NEXT:    fcvtzs v3.2d, v7.2d
; CHECK-i64-NEXT:    fcvtzs v6.2d, v5.2d
; CHECK-i64-NEXT:    fcvtzs v5.2d, v16.2d
; CHECK-i64-NEXT:    fcvtzs v7.2d, v17.2d
; CHECK-i64-NEXT:    ret
...
; CHECK-i64:       // %bb.0:
; CHECK-i64-NEXT:    ldp q18, q17, [sp, #32]
; CHECK-i64-NEXT:    ptrue p0.d, vl2
; CHECK-i64-NEXT:    ldp q16, q19, [sp, #96]
...
; CHECK-i64-NEXT:    // kill: def $q1 killed $q1 def $z1
; CHECK-i64-NEXT:    mov x9, #28 // =0x1c
; CHECK-i64-NEXT:    splice z18.d, p0, z18.d, z17.d
; CHECK-i64-NEXT:    splice z6.d, p0, z6.d, z7.d
; CHECK-i64-NEXT:    splice z4.d, p0, z4.d, z5.d
; CHECK-i64-NEXT:    splice z16.d, p0, z16.d, z19.d
; CHECK-i64-NEXT:    ldp q17, q19, [sp, #64]
; CHECK-i64-NEXT:    splice z2.d, p0, z2.d, z3.d
; CHECK-i64-NEXT:    splice z0.d, p0, z0.d, z1.d
; CHECK-i64-NEXT:    splice z17.d, p0, z17.d, z19.d
; CHECK-i64-NEXT:    ldp q19, q20, [sp]
; CHECK-i64-NEXT:    frintx z18.d, p1/m, z18.d
...
; CHECK-i64-NEXT:    splice z19.d, p0, z19.d, z20.d
; CHECK-i64-NEXT:    movprfx z3, z17
; CHECK-i64-NEXT:    frintx z3.d, p1/m, z17.d
; CHECK-i64-NEXT:    movprfx z5, z18
; CHECK-i64-NEXT:    ext z5.b, z5.b, z18.b, #16
; CHECK-i64-NEXT:    movprfx z7, z16
; CHECK-i64-NEXT:    ext z7.b, z7.b, z16.b, #16
; CHECK-i64-NEXT:    fcvtzs v17.2d, v18.2d
; CHECK-i64-NEXT:    fcvtzs v16.2d, v16.2d
; CHECK-i64-NEXT:    movprfx z20, z6
; CHECK-i64-NEXT:    ext z20.b, z20.b, z6.b, #16
; CHECK-i64-NEXT:    movprfx z21, z2
; CHECK-i64-NEXT:    ext z21.b, z21.b, z2.b, #16
; CHECK-i64-NEXT:    movprfx z1, z19
; CHECK-i64-NEXT:    frintx z1.d, p1/m, z19.d
; CHECK-i64-NEXT:    fcvtzs v6.2d, v6.2d
; CHECK-i64-NEXT:    fcvtzs v2.2d, v2.2d
; CHECK-i64-NEXT:    movprfx z18, z3
; CHECK-i64-NEXT:    ext z18.b, z18.b, z3.b, #16
; CHECK-i64-NEXT:    fcvtzs v5.2d, v5.2d
; CHECK-i64-NEXT:    fcvtzs v7.2d, v7.2d
; CHECK-i64-NEXT:    fcvtzs v3.2d, v3.2d
; CHECK-i64-NEXT:    fcvtzs v20.2d, v20.2d
; CHECK-i64-NEXT:    movprfx z19, z1
; CHECK-i64-NEXT:    ext z19.b, z19.b, z1.b, #16
; CHECK-i64-NEXT:    fcvtzs v18.2d, v18.2d
; CHECK-i64-NEXT:    fcvtzs v1.2d, v1.2d
; CHECK-i64-NEXT:    splice z17.d, p0, z17.d, z5.d
; CHECK-i64-NEXT:    movprfx z5, z4
; CHECK-i64-NEXT:    ext z5.b, z5.b, z4.b, #16
; CHECK-i64-NEXT:    splice z16.d, p0, z16.d, z7.d
; CHECK-i64-NEXT:    movprfx z7, z0
; CHECK-i64-NEXT:    ext z7.b, z7.b, z0.b, #16
; CHECK-i64-NEXT:    fcvtzs v4.2d, v4.2d
; CHECK-i64-NEXT:    fcvtzs v0.2d, v0.2d
; CHECK-i64-NEXT:    fcvtzs v19.2d, v19.2d
; CHECK-i64-NEXT:    splice z6.d, p0, z6.d, z20.d
; CHECK-i64-NEXT:    splice z3.d, p0, z3.d, z18.d
; CHECK-i64-NEXT:    fcvtzs v5.2d, v5.2d
; CHECK-i64-NEXT:    fcvtzs v18.2d, v21.2d
; CHECK-i64-NEXT:    fcvtzs v7.2d, v7.2d
; CHECK-i64-NEXT:    st1d { z16.d }, p1, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    mov x9, #24 // =0x18
; CHECK-i64-NEXT:    splice z1.d, p0, z1.d, z19.d
; CHECK-i64-NEXT:    st1d { z3.d }, p1, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    mov x9, #20 // =0x14
; CHECK-i64-NEXT:    splice z4.d, p0, z4.d, z5.d
; CHECK-i64-NEXT:    st1d { z17.d }, p1, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    mov x9, #16 // =0x10
; CHECK-i64-NEXT:    splice z2.d, p0, z2.d, z18.d
; CHECK-i64-NEXT:    splice z0.d, p0, z0.d, z7.d
; CHECK-i64-NEXT:    st1d { z1.d }, p1, [x8, x9, lsl #3]
; CHECK-i64-NEXT:    mov x9, #12 // =0xc
