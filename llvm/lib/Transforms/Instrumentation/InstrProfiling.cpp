...
void InstrLowerer::lowerIncrementAMDGPU(InstrProfIncrementInst *Inc) {
  ...
  const unsigned WavefrontSize =
      getAMDGPUWavefrontSize(*Inc->getFunction());
  ...
  Value *BlockIdx =
      Builder.CreateAdd(BlockIdxX,
                        Builder.CreateAdd(
                            Builder.CreateMul(BlockIdxY, GridDimX, "yTimesGx"),
  ...
  Value *CtlzVal = Builder.CreateCall(
      CtlzI32Fn, {TotalGridMinus1, Builder.getFalse()},
  ...
  Value *LeaderLane = IsWave64
                          ? Builder.CreateTrunc(LeaderLane64, Int32Ty, "leaderLane.trunc")
                          : LeaderLane64;
  ...
  Value *NumActive =
      Builder.CreateCall(CtpopFn, {ActiveMask}, "numActive");
  ...
  if (OffloadPGOSampling == OffloadPGOSamplingMode::PatternOverflow) {
    ...
    // matched = (sampBits == 0) ? true : ((linearBlockId & sampMask) == sampPat)
